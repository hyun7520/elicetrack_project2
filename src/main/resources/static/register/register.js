...
async function handleSubmit(e) {
  ...
  //이메일 중복 확인
  try {
    const duplicateCheckResult = await Api.get(`http://34.64.249.228.228:8080/users/checkEmail?email=${email}`);
  ...
  try {
    ...
    await Api.post("http://34.64.249.228.228:8080/users/sign-up", data);
