...
async function handleSubmit(e) {
  ...
  try {
    ...
    const response = await fetch("http://34.64.249.228.228:8080/products", {
      method: "POST",
      headers: {
...
async function uploadImage(file) {
  try {
    ...
    const response = await fetch("http://34.64.249.228.228:8080/products/upload-image", {
      method: 'POST',
      body: formData
    });
...
async function addOptionsToSelectBox() {
  try {
    const response = await fetch("http://34.64.249.228.228:8080/categories?parentId=1");
    if (!response.ok) {
